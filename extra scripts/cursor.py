...
def get_cursor_coords(event, x, y, flags, param):
...
cv.setMouseCallback('frame', get_cursor_coords)
...
while True:
    ...
    cursor_coords_text = "Cursor Coordinates (%d, %d)" % (cursor_x, cursor_y)
    cv.putText(frame, cursor_coords_text, (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
